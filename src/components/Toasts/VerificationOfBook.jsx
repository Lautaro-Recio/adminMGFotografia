        ...
        <div className='text-3xl text-red-500 block text-center items-center p-4 w-full'>
          ...
          <div className=' text-black justify-between items-center'>
            ...
            <div className='flex justify-around items-center'>
              <button className='text-sm border-2 border-red-500 p-2 rounded-md w-14' onClick={(e)=>{e.preventDefault(),deleteBookOnDB(e,book,true,t.id)}}>Si</button>
              <button className='text-sm border-2 border-red-500 p-2 rounded-md w-14' onClick={(e)=>{e.preventDefault(),deleteBookOnDB(e,book,false,t.id)}}>No</button>
            </div>
